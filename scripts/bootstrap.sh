...
#    or: wget -qO- https://raw.githubusercontent.com/USERNAME/dotfiles/main/scripts/bootstrap.sh | bash

set -e

REPO_URL="${DOTFILES_REPO:-https://github.com/USERNAME/dotfiles.git}"
